				...
				<div class="col-12">
					<div class="site-navbar">
						...
						<?php 
                            ...
                            {
                                echo "<li><a href='normalHomeRent.php'>FOR RENT</a></li>";
                            }
                            else
                            {
							...
							<li><a href="questions_builder.php">Feedback</a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="container">
          ...
          <div class="single-list-content">
						<div class="row">
							...
							<div class="col-xl-4">
								<a href="payment.php" class="price-btn"><?php echo "Bdt. ".$row['totalcost']."/-" ?></a>
							</div>
						</div>
